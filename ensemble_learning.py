...
ensemble_predictions['Final'].values

print(f"Ensemble Machine Learning Final Prediction: {ensemble_predictions['Final'].values}")

#lucky_nums, lucky_numbers = ensemble_predictions['Final'].values
...
print(f"EML with anomaly detection prediction: {final_predictions}")